...
// YAML parsing lives in ./yaml.js so hub.js can parse bundled profiles
// without a circular require on cli.js (cli.js requires hub.js at top,
// and is only fully exported after main() runs).
