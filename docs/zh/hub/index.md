...
| [qwen-code](https://github.com/jeffkit/agentproc/tree/main/hub/qwen-code) | `qwen`（阿里） | community | Python · Node |
...
| [kimi-code](https://github.com/jeffkit/agentproc/tree/main/hub/kimi-code) | `kimi`（月之暗面） | community | Python · Node |
